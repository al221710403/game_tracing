...
<footer class="flex flex-wrap items-center justify-between p-3 m-auto" style="background-color: #242526;">
    <div class="container mx-auto flex flex-col flex-wrap items-center justify-between">
        <ul class="flex mx-auto text-gray-300 text-center">
        ...
        <div class="flex mx-auto text-gray-300 text-center">
