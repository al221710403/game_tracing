<x-modal wire:model="show" maxWidth="md" label="true">
    <x-slot name="title">
        Crear nuevo juego
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="mt-4">
            <div class="relative z-0 mb-6 w-full group">
                <input wire:model.defer="name" type="text" name="name" id="name_game" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " autocomplete="off">
            ...
            <div class="relative z-0 mb-6 w-full group">
                <textarea wire:model.defer="description" id="description" name="description" rows="2" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " autocomplete="off"></textarea>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 mb-6 w-full group">
                    <input accept="image/*" wire:model.defer="backgroundImage" type="file" name="image" id="background_image" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " autocomplete="off">
                ...
                <div class="relative z-0 mb-6 w-full group">
                    <input wire:model.defer="siteGame" type="text" name="site" id="site_game" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " autocomplete="off">
    ...
    <x-slot name="footer">
        <button wire:click.prevent="Store()" type="button" class="mr-0 md:mr-2 mt-2 md:mt-0 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Guardar
        </button>
        <button wire:click="$set('show', false)" @click="show = false" type="button" class="px-3 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-red-400 rounded-md hover:bg-red-600 focus:outline-none focus:bg-red-500 focus:ring focus:ring-red-300 focus:ring-opacity-50">
            Cancelar
        </button>
    </x-slot>
</x-modal.modal-lg>
